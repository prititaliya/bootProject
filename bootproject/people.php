...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if($category == "both")
    $show_category_nav ="Members";
    else if($category == "people")
    $show_category_nav ="People";
    else if($category == "faculty")
    $show_category_nav ="Faculty";
...
<body>
    ...
    if($category == "staff" || $category == "faculty")
        ...
        <div class="card text-center">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo 'departmentdetail.php?deptname=' . $deptname; ?>&category=<?php echo $category; ?> ">About <?php echo $_GET['deptname']; ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="true" href="<?php echo $_SERVER['PHP_SELF'] . '?deptname=' . $deptname; ?>"><?php echo $show_category_nav; ?> of <?php echo $_GET['deptname']; ?></a>
                    </li>
                    <li class="nav-item">
